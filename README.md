[![Build Status](https://travis-ci.org/madelaporte/rails-travis-example.svg?branch=master)](https://travis-ci.org/secure-pipeline/rails-travis-example) [![Code Climate](https://codeclimate.com/github/madelaporte/rails-travis-example.png)](https://codeclimate.com/github/secure-pipeline/rails-travis-example)
